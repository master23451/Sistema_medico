                        ...
                        <form action="{{ route('paciente.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="container">
                                ...
                                <div class="px-2 py-4">
                                    ...
                                    <div class="mb-2 mt-2">
                                        <button class="btn btn-secondary" id="btnSelectImgPacienteAdmin" type="button"><i class="fas fa-portrait"></i> Elige una foto de perfil</button>
                                        <input type="file" class="w-full form-control"  id="imgPerfilPacienteAdmin" name="imgPerfilPacienteAdmin" style="display: none"/>
                                    </div>
                                </div>
                                <!--------------------------------------------------------------------------------------------------------->
                                <div class="row">
...
@section('js')
    ...
    <script type="text/javascript">
        const imgPerfilPacienteAdmin=document.getElementById('imgPerfilPacienteAdmin');
        const btnImgPacienteAdmin=document.getElementById('btnSelectImgPacienteAdmin');
        btnImgPacienteAdmin.addEventListener("click", function (){
            imgPerfilPacienteAdmin.click();
        });
    </script>
@stop
