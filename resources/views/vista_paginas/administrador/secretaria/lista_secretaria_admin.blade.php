        ...
        <div class="card-body">
            <div class="table-responsive-xl">
                <table class="table table-hover" id="tablaDatos">
                    ...
                    <tbody>
                    @foreach($secretaria as $itemsecretaria)
                        <tr style="text-align: center;">
                            ...
                            <td class="px-2 py-4"><a class="btn btn-warning" href="{{ route('secretaria.admin.edit', $itemsecretaria->id) }}"><i class="fas fa-info-circle"></i> Info</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
