...
class DoctorSecretariaController extends Controller
{
    ...
    public function index()
    {
        if(Gate::authorize('loginSecretaria')){
            ...
            $vista=view('vista_paginas.secretaria.doctor.vista_lista_doctor_secretaria', compact('datosDoctores'));
    ...
    public function create()
    {
       ...
       if(Gate::authorize('loginSecretaria')){
           ...
           $vista=view('vista_paginas.secretaria.doctor.crear_doctor_secretaria', compact('consultorios'));
    ...
    public function store(Request $request)
    {
        if(Gate::authorize('loginSecretaria')){
            ...
            return redirect()->route('secretaria.doctor.edit', $idr)->with('guardado','ok');
    ...
    public function edit($id)
    {
       if(Gate::authorize('loginSecretaria')){
           ...
           $consultorios=Consultorio::all();
           $vista=view('vista_paginas.secretaria.doctor.editar_info_doctor_secretaria', compact('doctor', 'consultorios'));
           return $vista;
